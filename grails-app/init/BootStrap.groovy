...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def testing = (new TaskType(name: "Testing", enabled: true)).save flush: true
        ...
        (new JobLog(person: person2, project: project1, task_type: testing, hours: "3", solicitude: 213485,observation: "Agregar ROL en el ABM de persona (en listado de personas)     ",date: new Date())).save flush: true
