...
<div ng-controller="PersonController as personCtrl">
    ...
    <table class="responsive-table striped centered" ng-controller="TsTableController as tableCtrl">
        ...
        filter:tableCtrl.search:tableCtrl.startsWith | filterByStatus:tableCtrl.status"
            ...
            <td class="width-5">
                <a href="#cu-modal" ng-click="personCtrl.edit(person)"
    ...
    <div id="cu-modal" class="modal modal-large">
        <form name="personCtrl.cuForm" ng-submit="personCtrl.createOrUpdate()" novalidate>
            <div class="modal-content modal-content-padding">
                ...
                <div class="row">
                    <div class="col s12">
                        <input name="name" type="text" maxlength="30" ng-model="personCtrl.cuPerson.name"
                               required/>
                        <label ng-class="{'has-error': personCtrl.cuForm.name.$invalid}">Nombre
                            <span ng-show="personCtrl.cuForm.name.$error.required"
                ...
                <div class="row">
                    <div class="col s12">
                        <input name="lastname" type="text" maxlength="30"
                               ng-model="personCtrl.cuPerson.lastname" required>
                        <label ng-class="{'has-error': personCtrl.cuForm.lastname.$invalid}">Apellido
                            <span ng-show="personCtrl.cuForm.lastname.$error.required"
                                  class="has-error">es obligatorio</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <input name="username" type="text" maxlength="25"
                               ng-model="personCtrl.cuPerson.username" required available
                               url-to-check="/people?username=" original-value="personCtrl.person.username">
                        <label ng-class="{'has-error': personCtrl.cuForm.username.$invalid}">Usuario
                            <span ng-show="personCtrl.cuForm.username.$error.required"
                                  class="has-error">es obligatorio</span>
                            <span ng-show="personCtrl.cuForm.username.$error.available"
                ...
                <div class="row">
                    <div class="col s12">
                        <input name="password" type="text" maxlength="8"
                               ng-model="personCtrl.cuPerson.password" ng-pattern="/[a-zA-Z]{8}/" required>
                        <label ng-class="{'has-error': personCtrl.cuForm.password.$invalid}">Contraseña
                            <span ng-show="personCtrl.cuForm.password.$error.required"
                                  class="has-error">es obligatoria</span>
                            <span ng-show="personCtrl.cuForm.password.$error.pattern"
                ...
                <div class="row">
                    <div class="col s12">
                        <select class="col s12 browser-default" name="position"
                                ng-model="personCtrl.cuPerson.work_position"
                        ...
                        <label class="modal-label modal-label-select left"
                               ng-class="{'has-error': personCtrl.cuForm.position.$invalid}">Posición
                            <span ng-show="personCtrl.cuForm.position.$error.required"
                                  class="has-error">es obligatoria</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <select class="col s12 browser-default" name="workHours"
                                ng-model="personCtrl.cuPerson.work_hours"
                                ng-options="work_hour for work_hour in personCtrl.work_hours" required>
                            <option value="" disabled selected>~ Elegí una hora ~</option>
                        </select>
                        <label class="modal-label modal-label-select left"
                               ng-class="{'has-error': personCtrl.cuForm.workHours.$invalid}">Horas
                            <span ng-show="personCtrl.cuForm.workHours.$error.required"
                                  class="has-error">es obligatoria</span>
                        </label>
                    </div>
                </div>
                ...
                %{--Enabled Checkbox--}%
                <ts-modal-checkbox label="Habilitado" ng-model="personCtrl.cuPerson.enabled"></ts-modal-checkbox>

            </div>

            %{--Button Row--}%
            <div class="modal-footer modal-footer-padding">
                <button class="modal-action modal-close btn-flat disabled" ng-disabled="personCtrl.cuForm.$invalid"
                        ng-class="{'teal-text teal-hover': personCtrl.cuForm.$valid}">{{personCtrl.actionToPerform}}</button>
