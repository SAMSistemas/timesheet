            ...
            <div class="modal-content modal-content-padding">
                ...
                <div class="row align-center">
                    <div class="input-field-modal col s12">
                        <input id="name" name="name" type="text" ng-model="taskTypeToCreate.name" required name-available>
    ...
    <div id="edit-modal" class="modal modal-width">
        <form name="editForm" ng-submit="update()" novalidate>
            <div class="modal-content modal-content-padding">
                ...
                <div class="row align-center">
                    <div class="input-field-modal col s12">
                        <input id="edit_name" name="name" type="text" ng-model="taskTypeToEdit.name" required name-available>
