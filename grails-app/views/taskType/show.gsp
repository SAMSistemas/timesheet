...
<html>
    ...
    <body>
        ...
        <div id="show-taskType" class="content scaffold-show" role="main">
            ...
            <f:display bean="taskType" />
            <g:form resource="${this.taskType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.taskType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
